...
8. **本卦、互卦、变卦的解读逻辑**：本卦表当前处境，互卦表发展过程，变卦表最终趋向。分析互卦和变卦时，应优先分析它们**自身**的体用生克关系来推断过程与结果。互变对本卦体卦的五行影响为非必须分析项，仅当影响显著时再说明。  
...
- 互变过程与结果简析：互卦（卦名）……（简述互卦自身的体用关系对过程的影响）；变卦（卦名）……（简述变卦自身的体用关系对结果的影响）。若互卦或变卦的上下卦对本卦体卦有显著五行影响，可额外附加说明，否则不写。  
