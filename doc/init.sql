...
REPLACE INTO "64gua" (id, name, full_name, shang, xia, gua_ci, gua_ci_js, chu_yao, chu_yao_js, er_yao, er_yao_js, san_yao, san_yao_js, si_yao, si_yao_js, wu_yao, wu_yao_js, shang_yao, shang_yao_js) VALUES(1, '乾', '乾为天', '乾', '乾', '乾：元，亨，利，贞。', '乾卦：大吉大利，吉祥的占卜。', '初九：潜龙，勿用。', '初九:龙星秋分时潜隐不见，不吉利。', '九二：见龙再田，利见大人。', '九二:龙星出现在天田星旁，对王公贵族有利。', '九三：君子终日乾乾，夕惕若，厉无咎。', '九三：有才德的君子整天勤勉努力，夜里也要提防危险，但最终不会有灾难。', '九四：或跃在渊，无咎。', '九四：有些大人君子跳进深潭自杀，并不是他们本身的过失。', '九五：飞龙在天，利见大人。', '九五：龙星春分时出现在天上，对王公贵族有利。', '上九：亢龙有悔。
用九：见群龙无首，吉。', '上九：龙星上升到极高的地方，是不吉利的征兆。
用九：卷曲的龙见不到头，是吉利的兆头。');
REPLACE INTO "64gua" (id, name, full_name, shang, xia, gua_ci, gua_ci_js, chu_yao, chu_yao_js, er_yao, er_yao_js, san_yao, san_yao_js, si_yao, si_yao_js, wu_yao, wu_yao_js, shang_yao, shang_yao_js) VALUES(2, '坤', '坤为地', '坤', '坤', '《坤》：元亨。利牝马之贞。君子有攸往，先迷，后得主，利。西南得朋，东北丧朋。安贞吉。', '坤卦：大吉大利。占问母马得到了吉利的征兆。君子贵族外出旅行经商，开始时迷了路，后来遇上招待客人的房东。往西南方向走有利，可以获得财物；往东北方向走会丧失财物。占问定居，得到吉利的预兆。', '初六：履霜，坚冰至。', '初六：脚下踩到了薄霜，结成坚实冰层的时令就快要到了。', '六二，直、方、大，不习，无不利。', '六二：大地的形貌平直、方正、辽阔；虽然去到不熟悉的陌生地方，也不会有什么问题。', '六三，含章，可贞，或从王事，无成有终。', '六三：周武王战胜殷商，是很好的占卜。有人参与战争，虽然没有战绩，但结局却很好。', '六四：括囊﹔無咎，無譽。', '六四：把收成装进口袋捆好，收成不好不坏。', '六五，黄裳，元吉。', '六五：黄色裙裤是大吉大利的象征。', '上六，龙战于野，其血玄黄。
用六，利永贞。', '上六：龙在旷野上争斗，血流遍地。
用六：这是永久吉利的最好征兆。');
REPLACE INTO "64gua" (id, name, full_name, shang, xia, gua_ci, gua_ci_js, chu_yao, chu_yao_js, er_yao, er_yao_js, san_yao, san_yao_js, si_yao, si_yao_js, wu_yao, wu_yao_js, shang_yao, shang_yao_js) VALUES(3, '屯', '水雷屯', '坎', '震', '屯：元，亨，利，贞，勿用，有攸往，利建侯。', '屯卦：大吉大利，吉祥的占卜。出门不利。有利于建国封侯。', '初九，磐桓，利居贞。利建侯。', '初九：徘徊难行。占问安居而得到吉利的征兆。有利于建国封侯。', '六二，屯如邅如，乘马班如。匪寇，婚媾。女子贞不字，十年乃字。', '六二：想前进又难于前进，乘着马车在原地回旋。这不是强盗前来抢劫，而是来求婚。占卜的结果是这个女子不能怀孕，十年之后才能生育。', '六三，即鹿无虞，惟入于林中，君子几不如舍，往吝。', '六三；追捕康鹿时没有熟悉山林的人当向导，正在想进入密林中去。君子很机智，认为不如放弃追捕。进入密林很艰难。', '六四，乘马班如，求婚媾。往吉，无不利。', '六四：乘着马车在原地回旋，因为是去求婚。前进的结果吉利，没有什么不利。', '九五，屯其膏，小，贞吉；大，贞凶。', '九五：把肥肉囤积起来。占问小事吉利，占问大事凶险。', '上六，乘马班如，泣血涟如。', '上六：乘着马车在原地回旋，悲痛得血泪流淌不断。');
REPLACE INTO "64gua" (id, name, full_name, shang, xia, gua_ci, gua_ci_js, chu_yao, chu_yao_js, er_yao, er_yao_js, san_yao, san_yao_js, si_yao, si_yao_js, wu_yao, wu_yao_js, shang_yao, shang_yao_js) VALUES(4, '蒙', '山水蒙', '艮', '坎', '《蒙》：亨。匪我求童蒙，童蒙求我。初筮告，再三渎，渎则不告。利贞。', '蒙卦：亨通。不是我请教蒙昧愚蠢的人，而是蒙昧愚蠢的人请教我。把第一次占筵的结果告诉了他，他却不恭敬地再三占筮； 对不恭敬的占筮，神灵不会告知。吉祥的占卜。', '初六，发蒙，利用刑人，用说桎梏，以往吝。', '初六：最好利用有罪的奴隶去伐木开荒，因此解开他们身上的枷锁。如果外出，不吉利。', '九二，包蒙，吉。纳妇，吉。子克家。', '九二：捆扎割下的荒草，吉利。正式礼聘迎娶妻子，吉利。男女一起建立家庭。', '六三，勿用取女，见金夫，不有躬。无攸利。', '六三：不要抢夺女子成婚，碰上拿着武器的人，会丧失性命。这样做没有什么好处。', '六四，困蒙，吝。', '六四：捆扎荒草。有危险。', '六五，童蒙，吉。', '六五：砍伐树木。吉利。', '上九，击蒙，不利为寇，利御寇。', '上九：割草伐木。充当强盗不利，抵御强盗有利。');
REPLACE INTO "64gua" (id, name, full_name, shang, xia, gua_ci, gua_ci_js, chu_yao, chu_yao_js, er_yao, er_yao_js, san_yao, san_yao_js, si_yao, si_yao_js, wu_yao, wu_yao_js, shang_yao, shang_yao_js) VALUES(5, '需', '水天需', '坎', '乾', '《需》：有孚，光亨。贞吉，利涉大川。', '需卦：捉到俘虏。大吉大利，吉祥的占卜。有利于渡过大江大河。', '初九，需于郊，利用恒，无咎。', '初九：在郊野停留等待，这样长久下去是吉利的，没有危险。', '九二，需于沙，小有言，终吉。', '九二：在沙地停留等待，出了一点小过错，最后结果是吉利的。', '九三，需于泥，致寇至。', '九三：在泥泞中停留等待，引来了强盗抢劫。', '六四，需于血，出自穴。', '六四：陷入到血污之中，从地穴住处里逃脱出来。', '九五，需于酒食，贞吉。', '九五：在酒席上留连等待，征兆吉利。', '上六，入于穴，有不速之客三人来，敬之终吉。', '上六：进入地穴住处，来了三个不请自来的客人。主人殷勤地接待他们，结果吉利。');
